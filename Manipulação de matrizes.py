...
def saida():
    ...
    #CÓDIGO 1 = inversa_matriz_triangular_superior(5)
    #CÓDIGO 2 = inversa_matriz_triangular_inferior(5)
    #CÓDIGO 3 = matriz_inversa(matriz_NxN)
    #CÓDIGO 4 = teste_inversa_matriz_triangular_superior(10,50)
    #CÓDIGO 5 = teste_inversa_matriz_triangular_inferior(10,50)
    #CÓDIGO 6 = teste_inversa_matriz_de_hilbert()
    
    questao = int(input("OBS: É possivel alterar as dimensões e as quantidades de testes no código.\n\nDigite 1 para calcular a inversa de uma matriz triangular superior.\nDigite 2 para calcula a inversa de uma matriz triangular inferior.\nDigite 3 para calcular a inversa de uma matriz nxn.\nDigite 4 para testar a eficácia do código 1.\nDigite 5 para testar a eficácia do código 2.\nDigite 6 para testar o código 3 na matriz de Hilbert"))
